...
/*TODO: (FOR THOSE WORKING ON THE GOOGLE MAPS API)
        ...
        -Get a working API Key (DONE)
        -Restrict API Key; get done before deployment
        -Add API key to the manifest file (DONE)
        -Add permissions ? (11:00 in tutorial) (DONE)
        -Look into Google Services, GPS, and location permissions (https://youtu.be/1f4b2-Y_q2A?list=PLgCYzUzKIBE-SZUrVOsbYMzH7tPigT3gi) (DONE? bug)
